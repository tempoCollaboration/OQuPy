...
"""
Skript to run the multiple environments performance analysis.
"""
...
from tests.performance.multi_env import ALL_TESTS
from tests.performance.multi_env import REQUIRED_PTS
...
with open('./tests/data/performance_results/multi_env.pkl', 'wb') as f:
