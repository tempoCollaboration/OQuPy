...
"""
Skript to run the bath dynamics performance analysis.
"""
...
from tests.performance.bath_dynamics import ALL_TESTS
from tests.performance.bath_dynamics import REQUIRED_PTS
...
with open('./tests/data/performance_results/bath_dynamics.pkl', 'wb') as f:
