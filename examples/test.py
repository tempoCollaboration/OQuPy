...
derivativeField = fieldEomGood(timeField, [stateField], fieldField)
print(derivativeField)
print(system.liouvillian(timeField, timeField+dtField, fieldField, derivativeField))
