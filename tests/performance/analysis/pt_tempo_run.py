...
"""
Skript to run the PT-TEMPO performance analysis.
"""
...
from tests.performance.pt_tempo import ALL_TESTS
from tests.performance.pt_tempo import REQUIRED_PTS
...
with open('./tests/data/performance_results/pt_tempo.pkl', 'wb') as f:
