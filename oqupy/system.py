...
class PropagatorSystem(BaseSystem):
    r"""
    Instead of supplying a hamiltonian simply supply a list of propagators, and
    supply their derivatives as well.
    """
    def __init__(
            self,
            propagators: List[ndarray],
            dprop_dparam: List[ndarray],
            dprop_dparam_indices: ndarray,
            dprop_dparam_times: Optional[ndarray] = None,
            name: Optional[Text] = None,
            description: Optional[Text] = None) -> None:
        ...
        dimension = np.sqrt(propagators[0].shape)
        self._dimension = dimension
...
class ParametrizedSystem(PropagatorSystem):
    r"""
    ...
    Indices for the time that dprop_dparam is given
    """
    def __init__(
            self,
